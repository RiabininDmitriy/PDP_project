...
export class BattleController {
  ...
  async getBattleStatus(@Param('battleId', ParseUUIDPipe) battleId: string, @Param('userId') userId: string, @Param('currentRound') currentRound: number): Promise<BattleStatusResponseDto> {
